...
def main():
    ...
    scripts = [
        ...
        {
            'name': 'AMR Bring Up',
            'start_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/amr-bring-up.sh',
            'end_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/term-amr-bring-up.sh',
        },

        {
            'name': 'AMR Health Monitor',
            'start_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/amr-health-monitor.sh',
            'end_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/term-amr-health-monitor.sh',
        },

        {
            'name': 'GPS Waypoint Logger',
            'start_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/amr-gps-wp-logger.sh',
            'end_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/term-amr-gps-wp-logger.sh',
        },

        {
            'name': 'GPS Waypoint Follower',
            'start_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/amr-gps-wp-follower.sh',
            'end_script_path': '/home/mowbot/mowbot_legacy/temp/scripts/term-amr-gps-wp-follower.sh',
        }
